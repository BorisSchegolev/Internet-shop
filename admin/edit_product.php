                            ...
                            <form enctype="multipart/form-data" method="post">
                                <ul id="edit-tovar">                            
                                    ...
                                    If (mysqli_num_rows($category) > 0) {
                                        ...
                                        if ($row["type_product"] == "mobile") $type_mobile = "selected";
                                        if ($row["type_product"] == "notebook") $type_notebook = "selected";
                                        if ($row["type_product"] == "notepad") $type_notepad = "selected";
                                    ...
                                    if  (strlen($row["img"]) > 0 && file_exists("../uploads_images/".$row["img"])) {
                                        ...
                                        echo '
                                            ...
                                            <div id="baseimg">
                                                ...
                                                <a href="edit_product.php?id='.$row["products_id"].'&img='.$row["img"].'&action=delete" ></a>
                                            </div>
                                    ...
                                    $query_img = mysqli_query($link,"SELECT * FROM uploads_images WHERE products_id='$id'");
                                        ...
                                        If (mysqli_num_rows($query_img) > 0) {
                                            ...
                                            do {
                                                if  (strlen($result_img["img"]) > 0 && file_exists("../uploads_images/".$result_img["img"])) {
                                                    $img_path = '../uploads_images/'.$result_img["img"];
                                                    $max_width = 100;
                                                    $max_height = 100;
                                                    list($width, $height) = getimagesize($img_path);
                                                    $ratioh = $max_height/$height;
                                                ...
                                                echo ' 
                                                 ...
                                                 <img src="'.$img_path.'" width="'.$width.'" height="'.$height.'" title="'.$result_img["img"].'" />
                                                ';
                                                if ($_SESSION['edit_tovar'] == '1') {
                                                    echo '
                                        ...
                                        echo ' 
                                            ...
                                            <ul id="chkbox">
                                            <li>
                                                <input type="checkbox" name="chk_visible" id="chk_visible" '.$checked1.' />
                                                <label for="chk_visible" >Показывать товар</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" name="chk_new" id="chk_new" '.$checked2.' />
                                                <label for="chk_new" >Новый товар</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" name="chk_leader" id="chk_leader" '.$checked3.' />
                                                <label for="chk_leader" >Популярный товар</label>
                                            </li>
                                            <li>
                                                <input type="checkbox" name="chk_sale" id="chk_sale" '.$checked4.' />
                                                <label for="chk_sale" >Товар со скидкой</label>
                                                </li>
                                        </ul> 
                                         <p align="right" >
