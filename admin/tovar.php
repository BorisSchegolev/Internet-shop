        ...
        if (isset($cat)) {
            switch ($cat) {
                ...
                case 'mobile':
                    ...
                    $url = "cat=mobile&";
                    $cat = "WHERE type_product='mobile'";
                    break;

                case 'notebook':
                    $cat_name = 'Ноутбуки';
                    $url = "cat=notebook&";
                    $cat = "WHERE type_product='notebook'";
                    break;

                case 'notepad':
                    $cat_name = 'Планшеты';
                    $url = "cat=notepad&";
                    $cat = "WHERE type_product='notepad'";
                    break;

                default:
                    $cat_name = $cat;
                    $url = "type=".clear_string($type)."&cat=".clear_string($cat)."&";
                    $cat = "WHERE type_product='".clear_string($type)."' AND brand='".clear_string($cat)."'";
                    break;
...
<!DOCTYPE html>
            ...
            <div class="content">
                <div class="block-parameters">
                    <ul class="options-list">
                        <li>Товары</li>
                        <li><a class="select-links" href="#"><? echo $cat_name; ?></a>
                ...
                <div class="block-info">
                    <p class="count-style">Всего товаров - <strong><?php echo $all_count_result; ?></strong></p>
                ...
                <?php
                    ...
                    if ($temp[0] > 0) {
                        $result = mysqli_query($link,"SELECT * FROM products $cat ORDER BY products_id DESC LIMIT $start, $num");
    ...
    // New dimensions
                    ...
                    // Находимо две ближайшие страницы с обоих краев, если они есть
