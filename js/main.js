$(document).ready(function () {
    ...
    $('.reloadcaptcha').click(function () {
        $('.captcha > img').attr("src", "reg/reg_captcha.php?r="+ Math.random());
    });

    $('.top-auth').toggle(function () {
        $('.block-top-auth').slideDown(400);
    },function () {
        $('.block-top-auth').slideUp(400);
    });

    //Открытый и закрытый глаз
...
/////////////////////////////////////////
    //Код для появления блока забыли пороль
    ...
    /*Profile*/
    $('#auth-user-info').toggle(function () {
        $('.profile-list').fadeIn(200)
    },function () {
        $('.profile-list').fadeOut(200);
    });
    ...
    $('.logout').click(function () {
        ...
        $('#auth-user-info').fadeOut();
        $('.profile-list').fadeOut();
    });

    /*Скрипт для вывода товара в списке поиск*/
    ...
    //Шаблон проверки email на правельность в контактной информации
    ...
    //Функции на уменьшение и прибавление товара
    ...
    //Добавление количества в input input-id по нажатию кнопки интер
    ...
    /*Проверка и отправка формы отзывов*/
    $('#button-send-review').click(function(){
        ...
        // Глобальная проверка и отвравка отзыва
