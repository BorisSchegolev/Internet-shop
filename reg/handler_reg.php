<?php
//Обработчик формы и добавление пользователя в базу данных
 if($_SERVER["REQUEST_METHOD"] == "POST") {
     ...
     $patronomic = iconv("UTF-8", "cp1251",clear_string($_POST['reg_patronomic']));
     ...
     if (strlen($patronomic) < 3 or strlen($patronomic) > 25) $error[] = "Укажите Отчество от 3 до 25 символов!";
     ...
     if (count($error)) {
         ...
         mysqli_query($link,"	INSERT INTO reg_user(login,pass,surname,name,patronomic,email,phone,address,datetime,ip)
						VALUES(
